...
var langText = {
    ...
    "#TextFact1": {
        "en": [
            "Do these strange animals have names?",
            "",
            "Yes! Their names are Jabu (left) and Duki (right)! The actual meanings of these names remain unclear. Jabu is often mistaken as an octopus (or a creature of its kind), but Jabu is definitely not an octopus.",
        ],
        "tw": [
            "這兩個生物有名字嗎？",
            "",
            "有！他們的名字是Jabu(左)和Duki(右)。名字的意思不明。順帶一提，Jabu並不是章魚(也不是類似章魚的生物)。"
        ],
    },
    "#TextFact2": {
        "en": [
            "When is the “birthday” of Jabu? ",
            "",
            "It is currently unknown. Based on Archeological data, the earliest Jabu-related product can be dated back to ~2005, when Hsiang-Chih was in middle school. Since the aesthetics of this particular Jabu product already exhibits artistic maturity, Jabu likely existed a few years before 2005. ", "Btw, Hsiang-Chih also uses Jabu as his signature in his credit card payment. ",
        ],
        "tw": [
            "Jabu 是什麼時候誕生的？",
            "",
            "Jabu的誕生日已不可考。但根據考古資料，目前最早的Jabu相關產品(下圖)可追溯至~2005年、翔致國中的美術課作業。但這個成品已展現 Jabu 作畫的高度成熟性，因此推估Jabu應於數年前就已誕生。", "順帶一提，翔致現在的信用卡簽名也是用Jabu。"
        ],
    },
    "#TextFact3": {
        "en": [
            "When is the “birthday” of Duki? ",
            "",
            "The concept of Duki was first formulated in 2017 by Hsiang-Chih. But the drawing of Duki has since been significantly modified (?) by Ting-Wei. In fact, Hsiang-Chih is not as good at drawing Duki due to Duki’s complexity."
        ],
        "tw": [
            "Duki 是什麼時候誕生的？",
            "",
            "第一個Duki是翔致於2017年時畫的(下方左圖)。但現今的Duki已經過亭維大量的改良。其實，因為Duki較複雜的結構，翔致不太擅長畫Duki。"
        ],
    },
    "#TextFact4": {
        "en": [
            ...
            "",
            "This website is made by Po-Hsien (tremendous technical help), Ting-Wei (all the illustrations and animations), and Hsiang-Chih (concept and content; his drawings are mostly on papers and thus are difficult to display on the website)!",
        ],
        "tw": [
            "這網站是如何製作的呢？",
            "",
            "這網站是由柏軒(大量的技術支援)、亭維(所有作圖、動畫)、翔致(網站概念及內容；翔致平常都畫在紙上，難以電子化)完成！"
        ],
    },
    "#TextPhotoHeader": {
        "en": "Photo gallery",
